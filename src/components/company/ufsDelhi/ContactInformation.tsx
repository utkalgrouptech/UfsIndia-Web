...
export default function ContactInformation() {
  return (
    <section className="lg:main-container w-full py-7 lg:px-0 px-3">
      <h1 className="text-3xl text-gray-700 py-2 lg:main-container">Contact Information</h1>

<div className="w-full flex flex-col lg:flex-row gap-6 lg:main-container">
      ...
      <div className=" w-full ">
        <div className="grid lg:grid-cols-3 grid-cols-1 gap-4 w-full">
          ...
          <div>
            ...
            <p className="py-2 text-gray-500">
               <Link href={'tel:+ +919776666555'}>Mobile: +91 9776666555</Link>  
            </p>
          </div>
